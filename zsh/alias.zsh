...
alias clocks="cd ~/docs/uni/code/itensor-clocks/"
...
alias unmount-lnxbo="fusermount3 -u ~/remote/lnxbo/"
alias unmount-tp1="fusermount3 -u ~/remote/theophys01/"
alias unmount-tp2="fusermount3 -u ~/remote/theophys02/"
